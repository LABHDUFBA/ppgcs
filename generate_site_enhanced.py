#!/usr/bin/env python3
"""
Generate enhanced static faculty site with Google Scholar data.
Uses the enhanced data from enhance_with_scholar_fixed.py
"""
...
def generate_site():
    """Generate the enhanced static site."""
    print("=" * 50)
    print("Generating ENHANCED PGPHCS Faculty Site")
    print("=" * 50)
        ...
        if recent_pubs:
            for pub in recent_pubs[:5]:  # Show top 5
                faculty_html += f"""                            <div class="card">
                                ...
                                <p><strong>Citations:</strong> {pb.get('citations', 0)}</p>
                            </div>
"""
        else:
